...
namespace AmbuMate.Entities
{
    public class Shift //: INotifyPropertyChanged
    {
        ...
        public static async void Insert(ShiftViewModel shift)
        {
            await App.MobileService.GetTable<ShiftViewModel>().InsertAsync(shift);
        }
        public static async void Update(ShiftViewModel shift)
        {
            await App.MobileService.GetTable<ShiftViewModel>().UpdateAsync(shift);
        }
/*
