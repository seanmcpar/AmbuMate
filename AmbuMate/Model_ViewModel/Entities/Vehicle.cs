...
namespace AmbuMate.Entities
{
    public class Vehicle //: INotifyPropertyChanged
    {
        ...
        public static async void Insert(VehicleViewModel vehicle)
        {
            await App.MobileService.GetTable<VehicleViewModel>().InsertAsync(vehicle);
        }

        public static async void Update(VehicleViewModel vehicle)
        {
            await App.MobileService.GetTable<VehicleViewModel>().UpdateAsync(vehicle);
        }
